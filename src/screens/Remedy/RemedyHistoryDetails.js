...
const RemedyHistoryDetails = ({navigation, route}) => {
  console.log(route?.params?.remedy_id)
  ...
  function continueButtonInfo() {
    return (
      <TouchableOpacity
        activeOpacity={0.8}
        onPress={() =>
          navigation.navigate('remedyBookingDetails', {
...
export default RemedyHistoryDetails;
